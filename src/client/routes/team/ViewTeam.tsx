...
import { DARK_TEXT_COLOR, LIGHT_TEXT_COLOR, HACKER_TEAMS_FOOTER_TEXT } from '../../assets/strings';
...
export const ViewTeam: FC<Props> = ({ teamName }: Props): JSX.Element => {
	...
	return (
		<FlexColumn>
			<Title fontSize="1.3rem" color={DARK_TEXT_COLOR} margin="0.5rem">
				You have joined:
			</Title>
			<Status background={LIGHT_TEXT_COLOR}>
				<CenterButtonText color={DARK_TEXT_COLOR} fontWeight="bold" fontSize="1.8rem">
					{teamName}
				</CenterButtonText>
			</Status>
